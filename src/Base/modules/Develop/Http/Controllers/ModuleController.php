...
use Xditn\Base\modules\Develop\Support\ModuleInstall;
 ...
 *
 * @subgroup            模块管理
 * @subgroupDescription MModule 后台模块管理
 */
class ModuleController extends XditnController
{
    ...
    {
        $defaultModel = ['develop', 'user', 'common', 'permissions', 'system'];
        if (in_array($name, $defaultModel)) {
            throw new FailedException('该模块禁止删除,如需删除,请手动到源码删除');
        }
